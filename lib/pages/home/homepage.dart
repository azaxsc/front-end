...
import 'package:hello_word/pages/addgrades/addgrades.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
                centerTitle: true,
                title:Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL3aGs03QCBnrqh62Mqptz-rx_hDGFWEsoVw&usqp=CAU', 
                                      width: 70,
                                      height: 70,
                                      ), 
                backgroundColor: Color(0xff01897d),),
